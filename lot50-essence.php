  ...
  <section class="max-w-md mx-auto px-6">
    <div class="card">
      <div class="gallery flex mb-6">
        ...
        <div class="main-image flex-1"><img id="main-img-lot50-essence" src="images/Piece/pro/a1000.png" alt="Lot de 50 – L’Essence des Royaumes" class="rounded w-full"></div>
      </div>
