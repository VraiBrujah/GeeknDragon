...
<header class="backdrop-blur bg-gradient-to-r from-gray-900/80 to-gray-800/60 shadow-lg fixed top-0 w-full z-[1200]">
  <div class="max-w-7xl mx-auto flex justify-between items-center p-4 md:px-6">
    ...
    <div class="flex items-center gap-6 md:gap-8">
      ...
      <div class="flex flex-col gap-4 md:flex-row md:items-center md:gap-8">
        <button class="snipcart-checkout snipcart-btn txt-court w-full md:w-auto text-sm md:text-base uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" data-i18n="nav.cart">
          Panier
          <span class="snipcart-items-count"></span>
        </button>
        <button class="snipcart-customer-signin snipcart-btn txt-court w-full md:w-auto text-sm md:text-base uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" data-i18n="nav.account">
          Compte
        </button>
      </div>
      <?php endif; ?>
  ...
  <nav id="mobile-menu" class="fixed inset-0 z-20 bg-gray-900/95 flex flex-col items-center p-8 text-white hidden md:hidden uppercase tracking-wide transform transition-transform duration-200 translate-x-full overflow-y-auto" aria-hidden="true" aria-label="Navigation mobile">
    ...
    <div class="mt-8 flex flex-col w-full gap-8">
      <button class="snipcart-checkout snipcart-btn txt-court w-full text-lg uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" data-i18n="nav.cart">
        Panier
        <span class="snipcart-items-count"></span>
      </button>
      <button class="snipcart-customer-signin snipcart-btn txt-court w-full text-lg uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" data-i18n="nav.account">Compte</button>
    </div>
    <?php endif; ?>
