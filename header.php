...
<header class="backdrop-blur bg-gradient-to-r from-gray-900/80 to-gray-800/60 shadow-lg fixed top-0 w-full z-[1200]">
  <div class="max-w-7xl mx-auto relative flex justify-between items-center p-4 md:px-6 flex-wrap gap-x-4 overflow-visible">
    ...
    <div class="flex flex-wrap items-center gap-6 md:gap-8">
      ...
      <?php if ($snipcartKey): ?>
      <!-- Snipcart -->
      <div class="flex flex-col gap-4 md:flex-row md:flex-wrap md:items-center md:gap-8 text-white z-10">
        ...
        <button class="snipcart-customer-signin snipcart-btn flex items-center justify-center gap-1 txt-court w-full text-center md:w-auto text-sm md:text-base uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg">
