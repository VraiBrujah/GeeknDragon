...
<header class="backdrop-blur bg-gradient-to-r from-gray-900/80 to-gray-800/60 shadow-lg fixed top-0 w-full z-[1200]">
  <div class="max-w-7xl mx-auto relative flex flex-nowrap items-center justify-between px-4 md:px-6 gap-x-4 gap-y-2 overflow-visible">
    ...
    <div class="flex items-center gap-4 md:gap-8 flex-shrink-0 flex-nowrap">
      ...
      <?php if ($snipcartKey): ?>
      <!-- Système hybride : Interface DnD + Snipcart fonctionnel -->
      <div class="flex items-center gap-2 flex-shrink-0 order-2 md:order-3 md:ml-auto">
        <button id="gd-account-toggle" class="gd-header-btn flex items-center justify-center gap-1 w-full text-center md:w-auto text-sm md:text-base uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" aria-label="Compte">
        ...
        <button id="gd-cart-toggle" class="gd-header-btn flex items-center justify-center gap-1 w-full text-center md:w-auto text-sm md:text-base uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" aria-label="Panier">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
          </svg>
          <span id="gd-cart-count" class="gd-cart-badge snipcart-items-count">0</span>
    ...
    <div class="mt-8 flex flex-col items-center gap-6 w-full">
      ...
      <div class="flex flex-col w-full gap-6">
        ...
        <button id="gd-cart-toggle-mobile" class="gd-header-btn w-full text-center text-lg uppercase tracking-wide hover:text-indigo-400 transition-colors duration-200" aria-label="Panier">
          ...
          <span class="gd-cart-badge-mobile snipcart-items-count">0</span>
          <span class="sr-only" data-i18n="nav.cart">Panier</span>
        </button>
      </div>
      <?php endif; ?>
