...
final class PaymentCapture
{
    public static function handle(): void
    {
        try {
            ...
            $paymentIntent = $stripeClient->capturePaymentIntent($transactionId, $amount);
            ...
            error_log('Snipcart Payment Capture: ' . json_encode([
                ...
                'amount_captured' => $paymentIntent->amount_received ?? $paymentIntent->amount,
                'capture_amount_requested' => $amount
            ]));
            ...
            $errorResult = [
                ...
                'error' => 'Erreur lors de la capture du paiement: ' . $e->getMessage()
            ];
