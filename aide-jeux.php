      ...
      <div class="dice-roller">
        ...
        <div class="bg-indigo-900/30 border border-indigo-700/50 rounded-lg p-4 mb-6">
          <p class="text-gray-300 text-center">
            <strong>D&D 2024 :</strong> Lancez 4d6, gardez les 3 meilleurs. Résultat : <strong class="text-yellow-300">Score (Modificateur)</strong>
          </p>
          <p class="text-sm text-gray-400 text-center mt-2" data-i18n="gameHelp.diceRoller.example">
            Ex: <strong>16 (+3)</strong> → Inscrivez <strong>16</strong> dans la case valeur, <strong>+3</strong> dans la case modificateur ET dans toutes les compétences associées (triptyque Historique)
          </p>
        </div>
        ...
        <div class="dice-grid">
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="str-details">
              <div class="text-xs text-gray-500 mt-2">Athlétisme</div>
            </div>
          </div>
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="dex-details">
              <div class="text-xs text-gray-500 mt-2">Acrobaties, Discrétion,<br>Escamotage</div>
            </div>
          </div>
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="con-details">
              <div class="text-xs text-gray-500 mt-2" data-i18n="gameHelp.diceRoller.conDetails">❤️ Pas de compétences<br><strong>Affecte PV :</strong><br>Mod × Niveau</div>
            </div>
          </div>
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="int-details">
              <div class="text-xs text-gray-500 mt-2">Arcanes, Histoire,<br>Investigation, Nature,<br>Religion</div>
            </div>
          </div>
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="wis-details">
              <div class="text-xs text-gray-500 mt-2">Dressage, Médecine,<br>Perception, Perspicacité,<br>Survie</div>
            </div>
          </div>
          <div class="text-center">
            ...
            <div class="stat-details hidden" id="cha-details">
              <div class="text-xs text-gray-500 mt-2">Intimidation, Persuasion,<br>Représentation, Supercherie</div>
            </div>
          </div>
        </div>
        ...
        <!-- Explications compactes intégrées -->
        <div class="grid md:grid-cols-2 gap-6 mt-8">
          <!-- Colonne gauche : Calcul compétences -->
          <div class="bg-gray-800/50 rounded-lg p-6">
            <h4 class="text-lg font-semibold mb-4 text-indigo-400">🧮 Calcul des compétences</h4>
            <div class="bg-indigo-900/30 border border-indigo-600/50 rounded p-3 mb-4">
              <p class="text-center text-yellow-300 font-bold">Bonus = Modificateur + Maîtrise</p>
            </div>

            <div class="space-y-3">
              <div class="flex items-center gap-3">
                <img src="/media/branding/icons/competence.webp" alt="Non maîtrisée" class="w-10 h-10">
                <p class="text-sm text-gray-300"><strong>Non maîtrisée :</strong> Modificateur seul</p>
              </div>
              <div class="flex items-center gap-3">
                <img src="/media/branding/icons/maitrise.webp" alt="Maîtrisée" class="w-10 h-10">
                <p class="text-sm text-gray-300"><strong>Maîtrisée :</strong> Mod + Bonus</p>
              </div>
              <div class="flex items-center gap-3">
                <img src="/media/branding/icons/expertise.webp" alt="Expertisée" class="w-10 h-10">
                <p class="text-sm text-gray-300"><strong>Expertisée :</strong> Mod + (Bonus×2)</p>
              </div>
            </div>

            <div class="mt-4 pt-4 border-t border-gray-700">
              <p class="text-xs text-gray-400"><strong>Bonus maîtrise :</strong> Niv 1-4:+2 • 5-8:+3 • 9-12:+4 • 13-16:+5 • 17-20:+6</p>
            </div>
          </div>

          <!-- Colonne droite : Exemple -->
          <div class="bg-gray-800/50 rounded-lg p-6">
            <h4 class="text-lg font-semibold mb-4 text-green-400">💡 Exemple (Dex 16, Niv 5)</h4>
            <p class="text-sm text-gray-400 mb-4">Score <strong>16</strong> → Mod <strong>+3</strong> • Bonus maîtrise <strong>+3</strong></p>

            <div class="space-y-2">
              <div class="bg-gray-700/50 rounded p-3 flex items-center gap-2">
                <img src="/media/branding/icons/competence.webp" alt="Non maîtrisée" class="w-6 h-6">
                <p class="text-sm"><strong>Acrobaties</strong> : +3 = <strong class="text-yellow-300">+3</strong></p>
              </div>
              <div class="bg-gray-700/50 rounded p-3 flex items-center gap-2">
                <img src="/media/branding/icons/maitrise.webp" alt="Maîtrisée" class="w-6 h-6">
                <p class="text-sm"><strong>Discrétion</strong> : +3+3 = <strong class="text-yellow-300">+6</strong></p>
              </div>
              <div class="bg-gray-700/50 rounded p-3 flex items-center gap-2">
                <img src="/media/branding/icons/expertise.webp" alt="Expertisée" class="w-6 h-6">
                <p class="text-sm"><strong>Escamotage</strong> : +3+3+3 = <strong class="text-yellow-300">+9</strong></p>
              </div>
            </div>

            <div class="mt-4 p-3 bg-amber-900/30 border border-amber-700/50 rounded">
              <p class="text-xs text-amber-300">→ Ces bonus vont sur le triptyque d'Historique</p>
            </div>
          </div>
        </div>

        <!-- Note finale compacte -->
        <div class="mt-6 p-4 bg-purple-900/30 border border-purple-700/50 rounded-lg">
          <p class="text-sm text-gray-300 text-center">
            <strong>Important :</strong> Ajoutez +2 et +1 (bonus Historique) aux caract.
          </p>
        </div>
      </div>
...
function rollStat(statName) {
    ...
    const animationInterval = setInterval(() => {
        ...
        if (animationCount > 10) {
            ...
            // Rendre visible les compétences associées
            const detailsElement = document.getElementById(statName + '-details');
            if (detailsElement) {
