...
# Générer la table des matières ÉPURÉE
table_matieres = """
...
table_matieres += """
        ...
        <div style="text-align: center; margin-top: 3em; padding: 1.5em; background: var(--gris-clair); border-radius: 10px;">
            <p style="font-size: 1.1em; color: var(--brun-chaud); margin: 0;"><strong>🎯 Table simplifiée - Chapitres principaux uniquement</strong></p>
            <p style="font-size: 0.9em; color: var(--gris-texte); margin-top: 0.5em;">120 recettes • 5 chapitres spéciaux • 11 sections thématiques • 5 annexes</p>
        </div>
    </div>
"""

# Template HTML avec la table des matières épurée
template_html = f'''<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>CARNIVAUTE - Guide Culinaire Spatial - Table Épurée</title>
    <style>
/* CARNIVAUTE - VERSION FINALE AVEC TABLE DES MATIÈRES ÉPURÉE */
...
.toc-dots {{
    ...
    background: repeating-linear-gradient(
        ...
        transparent 0px,
        transparent 5px,
        var(--orange-accent) 5px,
        var(--orange-accent) 10px
    );
    margin: 0 25px;
    opacity: 0.6;
}}
...
@media (max-width: 768px) {{
    ...
    h2 {{ font-size: 2em; }}
    h3 {{ font-size: 1.5em; }}
    .toc-item {{ font-size: 1.1em; margin: 1.5em 0; }}
    .toc-container {{ padding: 30px; }}
}}
</style>
</head>
<body>
    <div class="compatibility-status no-print">✅ TABLE ÉPURÉE</div>
...
{contenu_complet}
    ...
    <footer style="text-align: center; margin-top: 4em; padding: 2em; border-top: 3px solid var(--orange-accent);">
        ...
        <p style="font-size: 0.9em; color: var(--gris-moyen); margin-top: 1em;">Version Finale - Table des Matières Épurée</p>
    </footer>

</body>
</html>'''

# Sauvegarder le fichier final avec table épurée
with codecs.open(r'C:\Users\Brujah\Documents\GitHub\Carnivaute\CARNIVAUTE_TABLE_EPUREE.html', 'w', encoding='utf-8') as f:
    f.write(template_html)

print('TABLE DES MATIERES EPUREE!')
print(f'Taille finale: {len(template_html)} caracteres')
print('✅ Table simplifiee - Seulement les chapitres principaux')
print(f'Nombre de chapitres affiches: {len(titres_principaux)}')
print('Fichier sauve: CARNIVAUTE_TABLE_EPUREE.html')