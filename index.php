...
<body>
  ...
  <main id="main" class="pt-[var(--header-height)]">
    ...
    <section class="min-h-screen flex items-center justify-center text-center relative text-white">
      <div class="hero-videos absolute inset-0 w-full h-full" style="z-index:-1" data-videos='["videos/mage.mp4","videos/cascade_HD.mp4","videos/mage.mp4","videos/fontaine11.mp4","videos/mage.mp4","videos/fontaine4.mp4","videos/mage.mp4","videos/fontaine3.mp4","videos/mage.mp4","videos/fontaine2.mp4","videos/mage.mp4","videos/fontaine1.mp4","videos/mage.mp4","videos/Carte1.mp4","videos/mage.mp4"]'></div>
