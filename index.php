        ...
        <div class="text-center">
          ...
          <p class="mt-4 txt-court">
            <span class="payment-icons">
              <img src="/images/payments/visa.svg" alt="Logo Visa" class="h-5 w-auto" loading="lazy">
              <img src="/images/payments/mastercard.svg" alt="Logo Mastercard" class="h-5 w-auto" loading="lazy">
              <img src="/images/payments/american-express.svg" alt="Logo American Express" class="h-5 w-auto" loading="lazy">
            </span>
          </p>
        </div>
      </div>
