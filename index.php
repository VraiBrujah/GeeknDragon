...
<a href="boutique.php" class="btn btn-primary" data-hide-price="1" data-i18n="hero.visitShop">
    ...
    <section id="produits" class="py-16 bg-gray-900/80 scroll-mt-24">
      <div class="max-w-6xl mx-auto px-6">
        <h3 class="text-4xl font-bold text-center mb-12" data-i18n="home.incontournables.title">Nos Incontournables</h3>
        <div class="grid md:grid-cols-3 gap-10">
          <a href="boutique.php#cartes" class="card-product block no-underline hover:no-underline text-gray-100">
            <h4 class="text-center text-2xl font-semibold mb-2" data-i18n="home.incontournables.cards.title">Cartes d’équipement</h4>
            <p class="text-center" data-i18n="home.incontournables.cards.desc">560 cartes d’équipement illustrées pour remplacer la lecture fastidieuse du manuel</p>
          ...
          <a href="boutique.php#pieces" class="card-product block no-underline hover:no-underline text-gray-100">
            <h4 class="text-center text-2xl font-semibold mb-2" data-i18n="home.incontournables.coins.title">Pièces métalliques</h4>
            <p class="text-center" data-i18n="home.incontournables.coins.desc">Monnaie physique pour ressentir chaque trésor et influencer la chance à la table</p>
          ...
          <a href="boutique.php#triptyques" class="card-product block no-underline hover:no-underline text-gray-100">
            <h4 class="text-center text-2xl font-semibold mb-2" data-i18n="home.incontournables.triptych.title">Fiche Triptyque</h4>
            <p class="text-center" data-i18n="home.incontournables.triptych.desc">Créez et gérez votre perso sans ouvrir le moindre livre, sur trois volets robustes</p>
...
<!-- ===== BOUTIQUE ===== -->
    <section id="boutique" class="py-16 bg-gray-900/80 scroll-mt-24">
      <div class="max-w-6xl mx-auto px-6 text-center">
        <h3 class="text-4xl font-bold mb-12" data-i18n="home.shop.title">Boutique</h3>
          <p class="mb-8 txt-court">
            <span data-i18n="home.shop.payment">Paiement sécurisé via Snipcart</span>
            ...
            &nbsp;|&nbsp;
            <span data-i18n="home.shop.stock">Stocks mis à jour en temps réel.</span>
          </p>
        <div class="flex flex-col md:flex-row gap-6 justify-center">
          <a href="boutique.php" class="btn btn-primary" data-hide-price="1" data-i18n="home.shop.visit">
            Visiter la boutique
          </a>
          <a href="contact.php" class="btn btn-outline" data-i18n="home.shop.quote">
            Demander un devis
          </a>
        </div>
      </div>
    ...
    <section id="actus" class="py-16 bg-gray-900/80 scroll-mt-24">
      <div class="max-w-5xl mx-auto px-6">
        ...
        <h3 class="text-4xl font-bold text-center mb-12" data-i18n="home.news.heading">Actualité – FLIM 2025</h3>
        ...
        <article class="bg-gray-800 p-6 rounded-xl shadow-lg mb-12">
          ...
          <h4 class="text-3xl font-semibold mb-4" data-i18n="home.news.article1.title">Des héros niveau 20, un raton trop tenace, et… nos pièces</h4>
          <p class="text-lg text-gray-200 mb-4" data-i18n="home.news.article1.summary">
            Notre première démonstration de pièces au FLIM 2025 a pris la forme d’un one-shot légendaire animé par Es‑tu Game ?.
          </p>
          <div class="text-center">
            <a href="actualites/es-tu-game.php" class="btn btn-primary" data-i18n="home.news.article1.read">Lire l’article</a>
          </div>
        </article>
        ...
        <article class="bg-gray-800 p-6 mt-12 rounded-xl shadow-lg">
          ...
          <h4 class="text-center text-2xl font-semibold mb-4" data-i18n="home.news.testimonial.title">« Finis les combats contre nos feuilles de personnage ! »</h4>
          <p class="text-lg leading-relaxed text-gray-200" data-i18n="home.news.testimonial.intro">
            De nombreux joueurs présents l’affirment : les pièces physiques changent tout.
          </p>

  <p class="text-lg leading-relaxed text-gray-200" data-i18n="home.news.testimonial.story">
    Terminées les colonnes de chiffres gribouillées à la hâte sur une fiche froissée. Désormais, chaque joueur sentait le poids réel du butin, glissant entre ses doigts comme un héritage oublié. Un trésor devenu palpable. À chaque échange, c’était tout le corps qui réagissait : la main qui hésite, l’œil qui soupèse, la gorge qui sèche. Le trésor prenait chair. Il devenait enjeu dramatique, émotion viscérale, c’est un événement, un souvenir marquant...
            ...
            <p class="text-lg mt-4 leading-relaxed text-gray-200">
              <strong data-i18n="home.news.testimonial.emphasis">Fini les combats contre les feuilles de perso</strong>,
              <span data-i18n="home.news.testimonial.outro">les recherches interminables dans les livres pendant que les autres décrochent, ou les longues sessions 0 / 0.1 / 0.2 / 0.3... de création de personnages qui découragent avant même que le jeu commence. Avec Geek & Dragon, tout commence quand la pièce tombe sur la table.</span>
            </p>
        </article>
...
<!-- ===== CONTACT ===== -->
    <section id="contact" class="py-16 bg-gray-900/80 scroll-mt-32">
      <div class="max-w-xl mx-auto text-center">
        <h3 class="text-4xl font-bold mb-6" data-i18n="home.contact.title">Contact</h3>
        <img src="images/team_brujah.jpg" alt="Brujah" class="mx-auto h-32 w-32 rounded-full mb-4" loading="lazy">
          <p class="mb-2 txt-court"><strong>Brujah</strong> — <span data-i18n="home.contact.role">Responsable produit & communauté</span></p>
