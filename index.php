...
<!-- ===== CONTACT ===== -->
    <section id="contact" class="py-32 scroll-mt-32" style="background: linear-gradient(135deg, #1e293b 0%, #334155 50%, #1e293b 100%); position: relative; overflow: hidden;">
      <!-- Effet de fond animé -->
      ...
      <div class="max-w-3xl mx-auto text-center px-6" style="position: relative; z-index: 2;">
        ...
        <div style="background: linear-gradient(145deg, #1e293b 0%, #334155 100%); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 20px; padding: 3rem; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), 0 0 40px rgba(139, 92, 246, 0.1); margin: 2rem auto; max-width: 600px;">
          ...
          <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://discord.gg/geekndragon" class="btn btn-outline px-8 py-3" style="border: 2px solid #8b5cf6; color: #c7d2fe; font-weight: 600;" target="_blank">
