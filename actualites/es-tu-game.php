      ...
      <div class="max-w-5xl mx-auto px-6">
        ...
        <article class="bg-gray-800 p-6 rounded-xl shadow-lg">
          ...
          <div class="space-y-8 text-lg leading-relaxed text-gray-200">
            ...
            <p class="mt-4 italic text-sm text-gray-400" data-i18n="news.flim2025.p8">
              Retrouvez la table complète sur la chaîne YouTube officielle : <a href="https://www.youtube.com/@estugameofficieljdr" class="underline text-indigo-400" target="_blank">Es‑tu Game ? — Jeux de rôle</a>
            </p>
