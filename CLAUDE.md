...
- **Clean Code strictement appliqué** : Fonctions courtes (20-30 lignes max), noms explicites, responsabilité unique
...
- **Interfaces claires** : Contrats bien définis entre modules
...
- **Variables/méthodes explicites** : Noms auto-documentés en français ou anglais technique selon le contexte
- **Commentaires explicatifs** : Logique complexe expliquée en français (le "pourquoi", pas le "quoi")
...
- **Mode offline complet** : Application fonctionnelle sans connexion internet
...
- **Hardcodage interdit** : Aucune valeur codée en dur dans le code source
- **Données simulées interdites** : Toutes les données doivent être réelles ou configurables
...
- **Documentation complète** : 100% des fonctions publiques documentées en français
...
├── vendor.bundle.min.js     # Bundle vendor (générés automatiquement)
