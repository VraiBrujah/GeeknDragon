...
class SurveyViewer {
  ...
  async selectUser(username) {
    ...
    try {
      ...
      if (!contentExists) {
        ...
        // Activer TOUS les champs (retire disabled)
  ...
  /**
   * Active tous les champs (retire disabled) pour permettre édition
   */
  enableAllFields() {
    console.log('🔓 Activation de tous les champs pour édition...');
