...
<head>
  ...
  <title>Arsenal de l'Aventurier – 182 Cartes | Geek&Dragon</title>
  <meta name="description" content="Pack de 182 cartes d'équipement illustrées pour accélérer vos parties et enrichir l'immersion.">
...
<body>
  ...
  <main class="product-main">
    <section class="product-hero"><div class="container"><div class="product-hero-content">
      <div class="product-gallery"><div class="main-image"><img src="images/optimized-modern/webp/arme-recto.webp" alt="Arsenal de l'Aventurier" id="mainProductImage"></div></div>
      <div class="product-info">
        ...
        <div class="product-actions">
          <button class="snipcart-add-item btn-primary"
            ...
            data-item-name="Arsenal de l'Aventurier – 182 Cartes"
        ...
        <div class="product-tabs"><div class="tab-buttons"><button class="tab-btn active" data-tab="description">Description</button></div>
          <div class="tab-content active" id="description"><p>Référence visuelle claire, manipulation rapide, immersion renforcée.</p></div>
        </div>
      </div>
    </div></div></section>
  </main>
