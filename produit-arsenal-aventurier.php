                ...
                <div class="product-hero-content">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-configuration">
                            ...
                            <div class="custom-dropdown" id="custom-dropdown">
                                <div class="dropdown-selected" onclick="toggleDropdown()">
                                    <span class="selected-text">fr - 49.99$ CAD</span>
                                    <span class="dropdown-arrow">▼</span>
                                </div>
                                <div class="dropdown-options" id="dropdown-options">
                                    <div class="dropdown-option active" data-value="fr" data-price="49.99" data-description="Version française complète avec illustrations." onclick="selectOption(this)">
                                        <span class="option-title">fr</span>
                                        <span class="option-price">49.99$ CAD</span>
                                    </div>
                                    <div class="dropdown-option" data-value="en" data-price="49.99" data-description="Complete English version with illustrations." onclick="selectOption(this)">
                        ...
                        <div class="product-actions">
                            ...
                            <button class="btn-wishlist" onclick="handleWishlist('pack-182-arsenal-aventurier')" title="Ajouter aux favoris">
